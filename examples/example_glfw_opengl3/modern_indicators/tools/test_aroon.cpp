...
int main(int argc, char** argv) {
    ...
    std::cout << "====================================================================\n";
    std::cout << "AROON INDICATOR VALIDATION\n";
    std::cout << "====================================================================\n\n";
    ...
    std::vector<IndicatorTest> tests = {
        // AROON: Lookback
        {"AROON_UP_S", "AROON_UP_S", SingleIndicatorId::AroonUp, {14}},
        {"AROON_DOWN_S", "AROON_DOWN_S", SingleIndicatorId::AroonDown, {14}},
        {"AROON_DIFF_S", "AROON_DIFF_S", SingleIndicatorId::AroonDiff, {14}},
        {"AROON_UP_M", "AROON_UP_M", SingleIndicatorId::AroonUp, {50}},
        {"AROON_DOWN_M", "AROON_DOWN_M", SingleIndicatorId::AroonDown, {50}},
        {"AROON_UP_L", "AROON_UP_L", SingleIndicatorId::AroonUp, {120}},
        {"AROON_DOWN_L", "AROON_DOWN_L", SingleIndicatorId::AroonDown, {120}},
    };

    for (const auto& test : tests) {
        std::cout << "====================================================================\n";
        std::cout << test.name << " (Lookback=" << test.params[0] << ")\n";
        std::cout << "====================================================================\n";
